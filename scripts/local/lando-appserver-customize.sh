#!/bin/bash
  ...
  ###############################################################
    ...
    (service apache2 reload &>> ${setup_logs}/lando.log &&
      printout "SUCCESS" "Apache restarted.") || printout "WARNING" "Apache restarted failed."
