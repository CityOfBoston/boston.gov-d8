...
class AiSearchButtonBlock extends BlockBase {
  ...
  public function blockSubmit($form, FormStateInterface $form_state): void {
    ...
    $this->configuration['search_button_title'] = $form_state->getValue('display')['search_button_title'];
    $this->configuration['search_block_text'] = $form_state->getValue('display')['search_block_text'];
  }
