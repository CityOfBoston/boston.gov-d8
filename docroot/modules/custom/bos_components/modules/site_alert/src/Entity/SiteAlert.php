...
use Drupal\site_alert\SiteAlertInterface;
 ...
 *   bundle_label = @Translation("Site Alert type"),
 *   handlers = {
 ...
 *     "form" = {
 *       "add" = "Drupal\site_alert\Form\SiteAlertForm",
 *       "edit" = "Drupal\site_alert\Form\SiteAlertForm",
 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/site-alert/add/{site_alert_type}",
 *     "add-page" = "/admin/content/site-alert/add",
 *     "canonical" = "/site_alert/{site_alert}",
 ...
 *   },
 *   bundle_entity_type = "site_alert_type",
 *   field_ui_base_route = "entity.site_alert_type.edit_form"
 * )
 */
class SiteAlert extends RevisionableContentEntityBase implements SiteAlertInterface {
   ...
   * {@inheritdoc}
   *
   * When a new site alert entity is created, set the uid entity reference to
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['title'] = BaseFieldDefinition::create('string')
      ...
      ->setLabel(t('Title'))
      ->setDescription(t('The title of the site alert entity.'))
      ->setRequired(TRUE)
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ->setRevisionable(TRUE)
      ->setLabel(t('Status'))
      ->setDescription(t('A boolean indicating whether the site alert is enabled.'))
    ...
    $fields['description'] = BaseFieldDefinition::create('text_long')
      ...
      ->setDescription(t('A description of the site alert.'))
      ->setDisplayOptions('form', [
        'type' => 'text_textarea',
        'weight' => 10,
      ])
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setTranslatable(TRUE)
      ->setLabel(t('Author'))
      ->setDescription(t('The user ID of the site alert author.'))
