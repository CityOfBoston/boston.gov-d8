...
class MNL extends React.Component {
  constructor(props) {
    ...
    this.setCheckLocalStorage = (sam_id, sam_address, section) => {
    ...
    this.handleKeywordSubmit = event => {
      event.preventDefault();
      this.setState({
        isLoading: true,
        submittedKeywords: true,
    ...
    this.lookupAddress = event => {
      ...
      fetch("/jsonapi/node/neighborhood_lookup?filter" + paramsQuery.condition + "&filter" + paramsQuery.value + "&fields" + paramsQuery.fields + "&page[limit]=" + paramsQuery.limit + "&sort=" + paramsQuery.sort, {
        "mode": "cors",
        "headers": {
        ...
        if (result.data.length > 0) this.setState({
          isLoading: false,
    ...
    this.displayAddress = (sam_id, sam_address, section) => {
      ...
      let paramsSamGet = {
        ...
        fields: "[node--neighborhood_lookup]=field_sam_id,field_sam_neighborhood_data,field_sam_address"
      };
      let jsonData = "none";
      fetch("/jsonapi/node/neighborhood_lookup?filter" + paramsSamGet.value + "&fields" + paramsSamGet.fields, {
        "mode": "cors",
        "headers": {
          "Content-Type": "application/json",
          // Needed for CORS google translate
        ...
        if (result.data[0]) {
          ...
          let newState = _extends({}, this.state.itemsDisplay);
    ...
    this.displaySection = (display, event) => {
  ...
  render() {
    ...
    if (this.state.submittedKeywords) {
      if (itemsLookupArray.length > 0) {
        for (const [index, value] of itemsLookupArray.entries()) {
          resultItem = React.createElement(
            "button",
            {
              ...
              onClick: this.displayAddress.bind(this, itemsLookupArray[index].attributes.field_sam_id, itemsLookupArray[index].attributes.field_sam_address, null),
              key: index
            },
            React.createElement(
              "li",
              { className: "css-1tksw0t" },
              React.createElement(
                "div",
                {
        ...
        itemsLookupMarkup = React.createElement(
          "div",
          { className: "supporting-text" },
          "No address was found by that name."
        );
      }
    }
    let recollectEvents = this.state.isLoadingRecollect ? null : this.state.itemsRecollect;
    let configSection = configProps.sections;
    let mnlDisplay = this.state.submittedAddress ? React.createElement(
      "div",
      null,
      ...
      React.createElement(
        "div",
        { className: "g" },
        configSection.city_services.display ? React.createElement(CityServices, {
          recollect_events: recollectEvents,
          section: this.state.section,
          displaySection: this.displaySection
        }) : null,
        configSection.city_spaces.display ? React.createElement(CitySpaces, {
        ...
        configSection.representation.display ? React.createElement(Representation, {
        ...
        configSection.public_safety.display ? React.createElement(PublicSafety, {
        ...
        configSection.summer.display ? React.createElement(SummerResources, {
        ...
        configSection.winter.display ? React.createElement(WinterResources, {
        ...
        configSection.newsletter.display ? React.createElement(Newsletter, {
          section: this.state.section
        }) : null,
        configSection.bos_311.display ? React.createElement(Bos311, {
          section: this.state.section
        }) : null
      )
    ) : "";
    return React.createElement(
      "div",
      { className: "paragraphs-items paragraphs-items-field-components paragraphs-items-full paragraphs-items-field-components-full mnl" },
      React.createElement(
        "div",
        null,
...
ReactDOM.render(React.createElement(MNL, null), document.getElementById("web-app"));