...
class TransactionTypeForm extends BundleEntityFormBase {
  ...
  /**
   * Constructs the TransactionTypeForm object.
   *
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['id'] = [
      ...
      '#machine_name' => [
        'exists' => ['Drupal\transaction\Entity\TransactionType', 'load'],
        'source' => ['label'],
      ],
  ...
  protected function actions(array $form, FormStateInterface $form_state) {
    ...
    $actions['delete']['#value'] = $this->t('Delete transaction type');
    return $actions;
  }
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($status == SAVED_UPDATED) {
      $message = 'The transaction type %name has been updated.';
    }
    elseif ($status == SAVED_NEW) {
      $message = 'The transaction type %name has been added.';
    }
