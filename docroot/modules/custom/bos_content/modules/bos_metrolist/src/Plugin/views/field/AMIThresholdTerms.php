...
namespace Drupal\bos_metrolist\Plugin\views\field;
 ...
 *
 * @ViewsField("ami_threshold_terms")
 */
class AMIThresholdTerms extends EntityField {
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    $form['convert_spaces'] = [
      '#title' => $this->t('Convert spaces in term names to hyphens - CoB'),
      '#type' => 'checkbox',
