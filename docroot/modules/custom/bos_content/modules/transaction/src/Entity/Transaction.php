 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/transaction/add/{transaction_type}",
 *     "add-page" = "/admin/content/transaction/add",
 ...
 * )
 */
class Transaction extends RevisionableContentEntityBase implements TransactionInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ->setRevisionable(TRUE)
      ->setLabel(t('Status'))
      ->setDescription(t('A boolean indicating whether the transaction is enabled.'))
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setTranslatable(TRUE)
      ->setLabel(t('Author'))
      ->setDescription(t('The user ID of the transaction author.'))
