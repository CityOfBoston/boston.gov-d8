 ...
 *   },
 *   links = {
 *     "add-form" = "/admin/content/event/add/{event_type}",
 *     "add-page" = "/admin/content/event/add",
...
class Event extends RevisionableContentEntityBase implements EventInterface {
   ...
   * {@inheritdoc}
   *
   * When a new event entity is created, set the uid entity reference to
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ->setRevisionable(TRUE)
      ->setLabel(t('Status'))
      ->setDescription(t('A boolean indicating whether the event is enabled.'))
    ...
    $fields['uid'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setTranslatable(TRUE)
      ->setLabel(t('Author'))
      ->setDescription(t('The user ID of the event author.'))
