...
if [ "$target_env" = 'dev' ]; then
    ...
    /usr/local/drush8/drush $drush_alias pmu config_split -y
    /usr/local/drush8/drush $drush_alias cdel core.extension module.config_split -y
    ...
    /usr/local/drush8/drush $drush_alias en migrate -y
    ...
    /usr/local/drush8/drush $drush_alias cron
else
